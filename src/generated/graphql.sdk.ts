...
export const UpdateWorkflowDocument = gql`
  ...
  updateWorkflow(input: $input) {
    ...
    `;
export const EventSchemasDocument = gql`
...
export const WorkflowDocument = gql`
  ...
  workflow(rowId: $rowId) {
    ...
    `;
export const WorkflowVersionsDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    UpdatePlugin(variables: UpdatePluginMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdatePluginMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdatePluginMutation>({ document: UpdatePluginDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdatePlugin', 'mutation', variables);
    },
    ...
    EventSchemas(variables?: EventSchemasQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<EventSchemasQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<EventSchemasQuery>({ document: EventSchemasDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'EventSchemas', 'query', variables);
    },
    ...
    WorkflowVersions(variables: WorkflowVersionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<WorkflowVersionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<WorkflowVersionsQuery>({ document: WorkflowVersionsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'WorkflowVersions', 'query', variables);
    },

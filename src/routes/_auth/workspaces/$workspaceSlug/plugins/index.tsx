  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between">
        ...
        <button className="rounded-md bg-primary px-4 py-2 font-medium text-primary-foreground text-sm hover:bg-primary/90">
          Upload Plugin
        </button>
      </div>
      ...
      {installedPlugins.length === 0 ? (
        <div className="mt-16 text-center">
          ...
          <h3 className="mt-4 font-semibold text-lg">No plugins installed</h3>
          <p className="mt-2 text-muted-foreground">
